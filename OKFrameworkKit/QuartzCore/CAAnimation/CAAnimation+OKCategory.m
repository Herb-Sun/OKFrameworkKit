//
//  CAAnimation+OKCategory
//
//  Copyright © 2016年 OK Inc. All rights reserved.
//
#import "CAAnimation+OKCategory.h"
...
@implementation CAAnimation (OKCategory)

+ (EasingFunction)ok_blockForCAAnimationEasingFunction:(CAAnimationEasingFunction)easingFunction {
...
+ (CAKeyframeAnimation *)ok_transformAnimationWithDuration:(CGFloat)duration
    ...
    EasingFunction function = [CAAnimation ok_blockForCAAnimationEasingFunction:easingFunction];
...
+ (void)ok_addAnimationToLayer:(CALayer *)layer
                      duration:(CGFloat)duration
                     transform:(CATransform3D)transform
                easingFunction:(CAAnimationEasingFunction)easingFunction {
    CAAnimation *animation = [self ok_transformAnimationWithDuration:duration
...
+ (CAKeyframeAnimation *)ok_animationWithKeyPath:(NSString *)keyPath
                                        duration:(CGFloat)duration
...
+ (void)ok_addAnimationToLayer:(CALayer *)layer
                   withKeyPath:(NSString *)keyPath
                      duration:(CGFloat)duration
                            to:(CGFloat)endValue
                easingFunction:(CAAnimationEasingFunction)easingFunction {
    [self ok_addAnimationToLayer:layer
                     withKeyPath:keyPath
                        duration:duration
                   ...
                   withKeyPath:(NSString *)keyPath
                      duration:(CGFloat)duration
                          from:(CGFloat)startValue
                            to:(CGFloat)endValue
                easingFunction:(CAAnimationEasingFunction)easingFunction {
    CAAnimation *animation = [self ok_animationWithKeyPath:keyPath
                                                  duration:duration
                                                      from:startValue
                                                        to:endValue
                                            easingFunction:easingFunction];
