...
{
    method_replace(self.class, aClass, method);
}

- (BOOL)ok_respondsToSelector:(SEL)selector untilClass:(Class)stopClass
{
    return [self.class ok_instancesRespondToSelector:selector untilClass:stopClass];
}
...
{
    return [self.superclass ok_instancesRespondToSelector:selector untilClass:stopClass];
}
