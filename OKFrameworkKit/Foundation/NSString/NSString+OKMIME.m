...
#import "NSString+OKMIME.h"

@implementation NSString (OKMIME)

- (NSString *)ok_MIMEType {
    return [[self class] ok_MIMETypeForExtension:[self pathExtension]];
}

+ (NSString *)ok_MIMETypeForExtension:(NSString *)extension {
    return [[self ok_MIMEDict] valueForKey:[extension lowercaseString]];
}
